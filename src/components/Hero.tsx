          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-6 border border-white/20 max-w-md mx-auto">
            ...
            {showSuccessMessage && successBookingData && (
              <div className="text-center text-white">
                ...
                <p className="text-gray-200 mb-4">Thanks for booking Fastridedroptaxi! 🎉</p>
                <p className="text-yellow-300 text-sm mb-4">
                  📧📱 Fastridedroptaxi team has been notified via Email, WhatsApp & Telegram
                </p>
                ...
                <div className="text-center text-xs text-gray-300 mt-4">
                  ...
                  <p className="text-green-400 font-semibold mt-2">✅ Fastridedroptaxi team has been notified!</p>
