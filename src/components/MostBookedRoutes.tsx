        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {routes.map((route, index) => (
              <div
                key={index}
                className="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-100 rounded-xl p-6 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 group"
              >
                ...
                <div className="mb-4">
                  ...
                  {/* 🔥 Badge Added */}
                  <span className="text-xs bg-yellow-400 text-black px-2 py-1 rounded-full font-semibold mt-2 inline-block">
                    🔥 Most Booked
                  </span>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center py-2 border-b border-gray-200">
                    <span className="text-gray-700">
                      Distance ({selectedRoute.breakdown.totalKm} km × ₹{selectedRoute.breakdown.perKmRate}/km)
                    </span>
                    <span className="font-semibold">
                      ₹{selectedRoute.breakdown.totalKm * selectedRoute.breakdown.perKmRate}
                    </span>
                  </div>
