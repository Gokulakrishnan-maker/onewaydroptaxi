  ...
  return (
   <div className="fixed right-6 bottom-6 z-50 flex flex-col items-center space-y-4">
      ...
      <a
        ...
        className="relative bg-[#25D366] h-16 w-16 flex items-center justify-center rounded-full shadow-xl hover:scale-110 transition-all duration-300 group animate-[glow_1.8s_infinite_ease-in-out]"
        title="WhatsApp Us"
      >
        <img
